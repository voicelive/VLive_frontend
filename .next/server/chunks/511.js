...
function CreateChannel({
  ...
  (0,external_react_.useEffect)(() => {
    async function fetchData() {
      try {
        const response = await fetch(`${api/* API.URL */.b.URL}/episode`, {
          method: 'GET',
          headers: {
  ...
  async function submitData(ev) {
    ...
    try {
      const response = await fetch(`${api/* API.URL */.b.URL}/channel`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
      ...
      const res = await fetch(`${api/* API.URL */.b.URL}/channel/${channelId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json'
        },
